...
const Login = () => {
    ...
    const handleAddSubmit = async (e) => {
        ...
        try{
            ...
            let response = await fetch(process.env.REACT_APP_APIURL + '/employee/login', requestOptions)
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5 loginform">
                                ...
                                <Form onSubmit={handleAddSubmit}>
                                    <div className="form-row">
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <input type="text" className="form-control" name="email" placeholder="Enter Username" aria-label="Username" aria-describedby="basic-addon1" required />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        ...
                                        <div className="input-group mb-3">
                                            ...
                                            <input type="password" className="form-control" name="password" placeholder="Enter Password" aria-label="Username" aria-describedby="basic-addon1" required />
                                        </div>
                                    </div>
                                ...
                                <div className="social-link">
                                    <p className="forget"><a onClick={()=> navigate('/clientLogin')}>Signin as Client?</a></p>
                                </div>
